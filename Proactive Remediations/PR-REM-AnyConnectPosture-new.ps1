...
Try {
    ...
    New-ItemProperty -Path "HKLM:\Software\AFNI" -Name "001" -PropertyType "string" -Value 'F5lDAKHfivs^Q$faptis8oI767^CPdcbFgQhXKNxwUBsRU8u3r' -ErrorAction SilentlyContinue
    New-ItemProperty -Path "HKLM:\Software\AFNI" -Name "002" -PropertyType "string" -Value 'Jck6ELGhps3J@9*VhVLC9f2odTyC36SUNve5&CvdH7^8B$omr' -ErrorAction SilentlyContinue
